...
<html>
    ...
    <body>
        ...
        <div id="show-section" class="content scaffold-show" role="main">
            ...
            <f:display bean="section" />
            <g:form resource="${this.section}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.section}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
